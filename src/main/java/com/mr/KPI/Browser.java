...
public class Browser {
    public static class ForMapper extends Mapper<LongWritable,Text,Text,IntWritable>{
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if (kpi.getRequestStatus().equals("200")&& !kpi.getTheOther().equals("-\"")){
                    ikey.set(kpi.getTheOther());
            }
            else return;
    ...
    public static void main(String[] args) throws IOException, URISyntaxException, ClassNotFoundException, InterruptedException {
        ...
        Path path = new Path("G:\\hadoopout\\Browser");
        ...
        FileOutputFormat.setOutputPath(job,new Path("G:\\hadoopout\\Browser"));
